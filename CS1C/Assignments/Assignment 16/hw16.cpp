...
struct Cmp_by_id {
    ...
    { /* temp, replace when defining function... */ return s1->id < s2->id; } // dereference pointer, compare ids
};
...
public:
	...
	bool operator()(Val val) {return val < high && low < val;};
};
...
int main()
{
	...
	cout << "*      Programmed by Negin Mashhadi  * " << endl;
